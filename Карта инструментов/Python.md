...
Библиотека для работы с последовательным портом ставится в занятии [[з1.3 Встроенное программное обеспечение#^intro|1.3]], где появляется первый скрипт опроса платы:

``` bash
pip install pyserial
```

Библиотеки обработки и отображения данных — при первом их использовании в модуле 3:
